...
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_109_update,"AttachedAchievement","update",0x63d738cc,"AttachedAchievement.update","Achievements.hx",109,0xf249f7fa)
...
HXLINE(  97)		if (( (bool)(::Achievements_obj::achievementsUnlocked->__get(id)->__GetItem(1)) )) {
HXLINE(  98)			::String library = null();
HXDLIN(  98)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("achievementgrid",b5,fa,02,8a));
HXDLIN(  98)			 ::Dynamic _hx_tmp;
HXDLIN(  98)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  98)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE(  98)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("achievementgrid",b5,fa,02,8a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
HXDLIN(  98)			this->loadGraphic(_hx_tmp,true,150,150,null(),null());
HXLINE(  99)			this->animation->add(HX_("icon",79,e7,b2,45),::Array_obj< int >::__new(1)->init(0,id),0,false,false,null());
HXLINE( 100)			this->animation->play(HX_("icon",79,e7,b2,45),null(),null(),null());
            		}
            		else {
HXLINE( 102)			::String library = null();
HXDLIN( 102)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("lockedachievement",a5,23,f4,2a));
HXDLIN( 102)			 ::Dynamic _hx_tmp;
HXDLIN( 102)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 102)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE( 102)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("lockedachievement",a5,23,f4,2a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
HXDLIN( 102)			this->loadGraphic(_hx_tmp,null(),null(),null(),null(),null());
            		}
...
void AttachedAchievement_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_109_update)
HXLINE( 110)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE( 111)			this->setPosition((this->sprTracker->x - ( (Float)(130) )),(this->sprTracker->y + 25));
            		}
