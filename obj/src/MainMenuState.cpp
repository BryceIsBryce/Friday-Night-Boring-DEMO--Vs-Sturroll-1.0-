...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_143_giveAchievement,"MainMenuState","giveAchievement",0x39ddd809,"MainMenuState.giveAchievement","MainMenuState.hx",143,0x0e5db805)
...
HXLINE( 150)		this->selectedSomethin = false;
HXLINE( 142)		this->achievementID = 0;
HXLINE(  35)		this->optionShit = ::Array_obj< ::String >::fromData( _hx_array_data_205e8859_1,6);
...
HXLINE(  45)		::DiscordClient_obj::changePresence(HX_("In the Menus",0a,c1,ad,c6),null(),null(),null(),null());
HXLINE(  48)		this->camGame =  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
HXLINE(  49)		this->camAchievement =  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null());
HXLINE(  50)		{
HXLINE(  50)			 ::flixel::FlxCamera _hx_tmp = this->camAchievement;
HXDLIN(  50)			_hx_tmp->bgColor = (_hx_tmp->bgColor & 16777215);
HXDLIN(  50)			 ::flixel::FlxCamera _hx_tmp1 = this->camAchievement;
HXDLIN(  50)			_hx_tmp1->bgColor = (_hx_tmp1->bgColor | 0);
            		}
HXLINE(  52)		::flixel::FlxG_obj::cameras->reset(this->camGame);
HXLINE(  53)		::flixel::FlxG_obj::cameras->add(this->camAchievement,null()).StaticCast<  ::flixel::FlxCamera >();
HXLINE(  54)		::flixel::FlxCamera_obj::_defaultCameras = ::Array_obj< ::Dynamic>::__new(1)->init(0,this->camGame);
HXLINE(  56)		this->transIn = ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransIn;
HXLINE(  57)		this->transOut = ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransOut;
HXLINE(  59)		this->persistentUpdate = (this->persistentDraw = true);
HXLINE(  61)		Float yScroll = ::Math_obj::max((((Float)0.25) - (((Float)0.05) * ( (Float)((this->optionShit->length - 4)) ))),((Float)0.1));
HXLINE(  62)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  62)		::String library = null();
HXDLIN(  62)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("menuBG",24,65,6d,05));
HXDLIN(  62)		 ::Dynamic bg1;
HXDLIN(  62)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  62)			bg1 = imageToReturn;
            		}
            		else {
HXLINE(  62)			bg1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBG",24,65,6d,05)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
HXDLIN(  62)		 ::flixel::FlxSprite bg2 = bg->loadGraphic(bg1,null(),null(),null(),null(),null());
HXLINE(  63)		bg2->scrollFactor->set(0,yScroll);
HXLINE(  64)		bg2->setGraphicSize(::Std_obj::_hx_int((bg2->get_width() * ((Float)1.175))),null());
...
HXLINE(  75)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  75)		::String library1 = null();
HXDLIN(  75)		 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(HX_("menuDesat",26,91,04,72));
HXDLIN(  75)		 ::Dynamic _hx_tmp3;
HXDLIN(  75)		if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  75)			_hx_tmp3 = imageToReturn1;
            		}
            		else {
HXLINE(  75)			_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            		}
HXDLIN(  75)		this->magenta = _hx_tmp2->loadGraphic(_hx_tmp3,null(),null(),null(),null(),null());
HXLINE(  76)		this->magenta->scrollFactor->set(0,yScroll);
HXLINE(  77)		 ::flixel::FlxSprite _hx_tmp4 = this->magenta;
HXDLIN(  77)		_hx_tmp4->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.175))),null());
HXLINE(  78)		this->magenta->updateHitbox();
HXLINE(  79)		this->magenta->screenCenter(null());
HXLINE(  80)		this->magenta->set_visible(false);
HXLINE(  81)		this->magenta->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
...
HXLINE(  91)				Float offset = (( (Float)(108) ) - ((::Math_obj::max(( (Float)(this->optionShit->length) ),( (Float)(4) )) - ( (Float)(4) )) * ( (Float)(80) )));
HXLINE(  92)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,((i * 140) + offset),null());
HXLINE(  93)				::String key = (HX_("mainmenu/menu_",a9,7b,4b,27) + this->optionShit->__get(i));
HXDLIN(  93)				::String library = null();
HXDLIN(  93)				 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(key);
...
HXLINE(  93)					 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN(  93)					if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  93)						_hx_tmp = imageToReturn;
            					}
            					else {
HXLINE(  93)						_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            					}
            				}
...
HXDLIN(  93)				menuItem->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
...
HXLINE( 100)				Float scr = (( (Float)((this->optionShit->length - 4)) ) * ((Float)0.135));
HXLINE( 101)				if ((this->optionShit->length < 6)) {
HXLINE( 101)					scr = ( (Float)(0) );
            				}
HXLINE( 102)				menuItem->scrollFactor->set(0,scr);
HXLINE( 103)				menuItem->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 105)				menuItem->updateHitbox();
            			}
            		}
HXLINE( 108)		::flixel::FlxG_obj::camera->follow(this->camFollowPos,null(),1);
HXLINE( 110)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,(::flixel::FlxG_obj::height - 64),0,(HX_("Tutorial v",94,53,a0,bd) + ::MainMenuState_obj::tutorialVersion),12,null());
HXLINE( 111)		versionShit->scrollFactor->set(null(),null());
HXLINE( 112)		versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 113)		this->add(versionShit);
HXLINE( 114)		 ::flixel::text::FlxText versionShit1 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,(::flixel::FlxG_obj::height - 44),0,(HX_("Psych Engine v",5d,a0,37,c7) + ::MainMenuState_obj::psychEngineVersion),12,null());
HXLINE( 115)		versionShit1->scrollFactor->set(null(),null());
HXLINE( 116)		versionShit1->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 117)		this->add(versionShit1);
HXLINE( 118)		int versionShit2 = (::flixel::FlxG_obj::height - 24);
HXDLIN( 118)		 ::flixel::text::FlxText versionShit3 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,versionShit2,0,(HX_("Friday Night Funkin' v",03,65,b0,2f) + ::lime::app::Application_obj::current->meta->get(HX_("version",18,e7,f1,7c))),12,null());
HXLINE( 119)		versionShit3->scrollFactor->set(null(),null());
HXLINE( 120)		versionShit3->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 121)		this->add(versionShit3);
HXLINE( 125)		this->changeItem(null());
HXLINE( 128)		::Achievements_obj::loadAchievements();
HXLINE( 129)		 ::Date leDate = ::Date_obj::now();
HXLINE( 130)		bool _hx_tmp5;
HXDLIN( 130)		bool _hx_tmp6;
HXDLIN( 130)		if (!(( (bool)(::Achievements_obj::achievementsUnlocked->__get(this->achievementID)->__GetItem(1)) ))) {
HXLINE( 130)			_hx_tmp6 = (leDate->getDay() == 5);
            		}
            		else {
HXLINE( 130)			_hx_tmp6 = false;
            		}
HXDLIN( 130)		if (_hx_tmp6) {
HXLINE( 130)			_hx_tmp5 = (leDate->getHours() >= 18);
            		}
            		else {
HXLINE( 130)			_hx_tmp5 = false;
            		}
HXDLIN( 130)		if (_hx_tmp5) {
HXLINE( 131)			::Achievements_obj::achievementsUnlocked->__get(this->achievementID)->__SetItem(1,true);
HXLINE( 132)			this->giveAchievement();
...
void MainMenuState_obj::giveAchievement(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_143_giveAchievement)
HXLINE( 144)		this->add( ::AchievementObject_obj::__alloc( HX_CTX ,this->achievementID,this->camAchievement));
HXLINE( 145)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 145)		_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
HXLINE( 146)		::haxe::Log_obj::trace((HX_("Giving achievement ",c3,c2,17,97) + this->achievementID),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),146,HX_("MainMenuState",59,88,5e,20),HX_("giveAchievement",1e,ea,83,24)));
            	}
...
HXLINE( 245)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 246)			{
HXLINE( 246)				 ::flixel::FlxSprite _g = spr;
HXDLIN( 246)				_g->set_x((_g->x - ( (Float)(250) )));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_153_update)
HXLINE( 152)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 154)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 156)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 156)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 159)		Float lerpVal = ::CoolUtil_obj::boundTo((elapsed * ((Float)5.6)),( (Float)(0) ),( (Float)(1) ));
HXLINE( 160)		Float a = this->camFollowPos->x;
HXDLIN( 160)		Float a1 = this->camFollowPos->y;
HXDLIN( 160)		this->camFollowPos->setPosition((a + (lerpVal * (this->camFollow->x - a))),(a1 + (lerpVal * (this->camFollow->y - a1))));
HXLINE( 162)		if (!(this->selectedSomethin)) {
...
HXLINE( 170)			if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
...
HXLINE( 178)				this->selectedSomethin = true;
...
HXLINE( 180)				::MusicBeatState_obj::switchState( ::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            			}
HXLINE( 183)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 185)				if ((this->optionShit->__get(::MainMenuState_obj::curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 187)					::CoolUtil_obj::browserLoad(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92));
            				}
            				else {
...
HXLINE( 198)						if ((::MainMenuState_obj::curSelected != spr->ID)) {
...
HXLINE( 212)								::String daChoice = _gthis->optionShit->__get(::MainMenuState_obj::curSelected);
HXLINE( 214)								::String _hx_switch_0 = daChoice;
            								if (  (_hx_switch_0==HX_("awards",b6,92,c1,8d)) ){
HXLINE( 221)									::MusicBeatState_obj::switchState( ::AchievementsMenuState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 221)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("credits",1a,0e,5e,13)) ){
HXLINE( 223)									::MusicBeatState_obj::switchState( ::CreditsState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 223)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 219)									::MusicBeatState_obj::switchState( ::FreeplayState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 219)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 225)									::MusicBeatState_obj::switchState( ::OptionsState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 225)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("story_mode",2d,63,e6,a4)) ){
HXLINE( 217)									::MusicBeatState_obj::switchState( ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 210)							::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 191)					this->selectedSomethin = true;
HXLINE( 192)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 192)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 194)					if (::ClientPrefs_obj::flashing) {
HXLINE( 194)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 196)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),null());
            				}
            			}
            			else {
HXLINE( 233)				 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 233)				if (_this->keyManager->checkStatus(55,_this->status)) {
HXLINE( 235)					this->selectedSomethin = true;
HXLINE( 236)					::MusicBeatState_obj::switchState( ::editors::MasterEditorMenu_obj::__alloc( HX_CTX ,null(),null()));
            				}
            			}
            		}
HXLINE( 241)		this->super::update(elapsed);
HXLINE( 243)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_3()),null());
            	}
...
HXLINE( 250)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
::String MainMenuState_obj::tutorialVersion;
...
bool MainMenuState_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"tutorialVersion") ) { outValue = ( tutorialVersion ); return true; }
		break;
	case 18:
...
bool MainMenuState_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"tutorialVersion") ) { tutorialVersion=ioValue.Cast< ::String >(); return true; }
		break;
	case 18:
...
static ::hx::StaticInfo MainMenuState_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &MainMenuState_obj::tutorialVersion,HX_("tutorialVersion",1a,cf,0f,33)},
...
static void MainMenuState_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(MainMenuState_obj::tutorialVersion,"tutorialVersion");
...
static void MainMenuState_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(MainMenuState_obj::tutorialVersion,"tutorialVersion");
...
static ::String MainMenuState_obj_sStaticFields[] = {
	HX_("tutorialVersion",1a,cf,0f,33),
...
HXDLIN(  27)		tutorialVersion = HX_("0.1.0",75,ff,c8,c1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_28_boot)
HXDLIN(  28)		psychEngineVersion = HX_("0.4.2",3a,46,cb,c1);
            	}
{
