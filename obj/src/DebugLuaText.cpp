...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1348_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1348,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1360_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",1360,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1348_new)
HXLINE(1350)		this->disableTime = ((Float)6);
HXLINE(1353)		this->parentGroup = parentGroup;
HXLINE(1354)		super::__construct(10,10,0,text,16,null());
HXLINE(1355)		this->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1356)		this->scrollFactor->set(null(),null());
HXLINE(1357)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1360_update)
HXLINE(1361)		this->super::update(elapsed);
HXLINE(1362)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1362)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(1363)		if ((this->disableTime <= 0)) {
HXLINE(1364)			this->kill();
HXLINE(1365)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(1366)			this->destroy();
            		}
            		else {
HXLINE(1368)			if ((this->disableTime < 1)) {
HXLINE(1368)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
