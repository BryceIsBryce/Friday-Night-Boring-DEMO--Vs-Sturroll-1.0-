...
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_54_unlockAchievement,"Achievements","unlockAchievement",0xddbd5e61,"Achievements.unlockAchievement","Achievements.hx",54,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_61_loadAchievements,"Achievements","loadAchievements",0x7629cad4,"Achievements.loadAchievements","Achievements.hx",61,0xf249f7fa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_53_boot,"Achievements","boot",0x8eb5af9c,"Achievements.boot","Achievements.hx",53,0xf249f7fa)
...
void Achievements_obj::unlockAchievement(int id){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_54_unlockAchievement)
HXLINE(  56)		::Achievements_obj::achievementsUnlocked->__get(id)->__SetItem(1,true);
HXLINE(  57)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  57)		_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
            	}
...
void Achievements_obj::loadAchievements(){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_61_loadAchievements)
HXDLIN(  61)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data )) {
HXLINE(  62)			if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("achievementsUnlocked",67,55,27,1c),::hx::paccDynamic) )) {
HXLINE(  64)				::Array< ::String > savedStuff = ( (::Array< ::String >)(::flixel::FlxG_obj::save->data->__Field(HX_("achievementsUnlocked",67,55,27,1c),::hx::paccDynamic)) );
HXLINE(  65)				{
HXLINE(  65)					int _g = 0;
HXDLIN(  65)					int _g1 = ::Achievements_obj::achievementsUnlocked->get_length();
HXDLIN(  65)					while((_g < _g1)){
HXLINE(  65)						_g = (_g + 1);
HXDLIN(  65)						int i = (_g - 1);
HXLINE(  66)						{
HXLINE(  66)							int _g1 = 0;
HXDLIN(  66)							int _g2 = savedStuff->length;
HXDLIN(  66)							while((_g1 < _g2)){
HXLINE(  66)								_g1 = (_g1 + 1);
HXDLIN(  66)								int j = (_g1 - 1);
HXLINE(  67)								if (::hx::IsEq( ::Achievements_obj::achievementsUnlocked->__get(i)->__GetItem(0),savedStuff->__get(j) )) {
HXLINE(  68)									::Achievements_obj::achievementsUnlocked->__get(i)->__SetItem(1,true);
            								}
            							}
            						}
            					}
...
HXDLIN(  73)			if ((::Achievements_obj::henchmenDeath == 0)) {
HXLINE(  73)				_hx_tmp = ::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("henchmenDeath",f4,76,2a,dd),::hx::paccDynamic) );
            			}
            			else {
HXLINE(  73)				_hx_tmp = false;
            			}
HXDLIN(  73)			if (_hx_tmp) {
HXLINE(  74)				::Achievements_obj::henchmenDeath = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("henchmenDeath",f4,76,2a,dd),::hx::paccDynamic)) );
            			}
            		}
            	}
